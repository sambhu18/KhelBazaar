...
export default function Loyalty() {
  ...
  const getTierColor = (tier: string) => {
    switch(tier) {
      ...
      case 'platinum': return { bg: 'bg-teal-50', text: 'text-teal-700', badge: 'bg-teal-500' };
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <p className="text-3xl font-bold text-green-600 mt-2">
                ${(loyaltyData.reduce((sum, d) => sum + d.totalSpent, 0) / (loyaltyData.length || 1)).toFixed(2)}
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          {loading ? (
            <div className="flex justify-center items-center h-64">
              <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#00B8AE]" />
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="px-4 pb-4">
                      <button className="w-full py-2 px-4 rounded-lg font-medium bg-[#00B8AE] text-white hover:bg-teal-600 transition">
                        View Details
                      </button>
                    </div>
                  </div>
